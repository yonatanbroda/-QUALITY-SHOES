...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user->email = 'Homero_tompsonr@gmail.com';
        $user->password = bcrypt('abcd12934');
        $user->save();
        ...
        $user->direccion = 'Av. Toronto';
        $user->email = 'kaice444@gmail.com';
        $user->password = bcrypt('soynumero1');
        $user->save();
        $user->assignRole('Cliente');
    }
}
