...
<body>
    ...
    <div class="contenedor-formulario">
        <div class="formulario-ingreso">
            <form method="POST" action="{{ route('login') }}" class="login3">
                @csrf
                <div class="imagen-usuario">
                    <img src="{{ asset('img/login-w-icon.png') }}" alt="AVATAR">
                </div>
                ...
                <div class="campo-texto" data-validate="Contraseña requerida">
                ...
                <label class="form-check-label" for="remember">
                    <input class="form-check-input" type="checkbox" name="remember" id="remember"
                        {{ old('remember') ? 'checked' : '' }}><span class="lever"></span>
                    {{ __('Remember Me') }}
                </label>
                ...
                <div class="btn-facebook-app">
                    <a href="{{ url('auth/facebook') }}" action="{{ route('login') }}">Iniciar con facebook</a>
                </div>
                ...
                <div class="crear-cuenta">¿Aún no tienes una cuenta? |
                    <a href="{{ route('register') }}">Crear una cuenta
                    </a>
                </div>
